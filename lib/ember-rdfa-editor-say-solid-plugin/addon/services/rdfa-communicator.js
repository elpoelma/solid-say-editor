...
export default class RdfaCommunicatorService extends Service {
    ...
    constructor() {
        ...
        rdflib.Fetcher.crossSiteProxyTemplate = "https://proxy.linkeddatafragments.org/{uri}";
    }
    ...
    fetchTriples(subject, attributes, graph, options = {}) {
        return new Promise((resolve, reject) => {
            ...
            if(options.isProxy){
                graph = rdflib.Fetcher.crossSiteProxy(graph.value); 
                console.log("Proxied!");
                console.log(graph);
            }
    ...
    fetchRemoteQuads(subject, attributes, graph) {
        return new Promise((resolve, reject) => {
            this.fetchTriples(subject, attributes, graph, {isProxy: true }).then(quads => {
                resolve(quads);
            }).catch(err => {
                resolve([]);
            })
